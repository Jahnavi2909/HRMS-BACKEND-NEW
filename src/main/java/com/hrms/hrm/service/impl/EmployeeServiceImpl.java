...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public EmployeeResponseDto createEmployee(EmployeeRequestDto request) {
        ...
        Department department = departmentRepository.findDepartmentByName(request.getDepartmentName())
                .orElseThrow(() ->
                        new ResourceNotFoundException("Department not found with name: " + request.getDepartmentName()));
        ...
        try {
            notificationService.sendNotification(
                    NotificationRequestDto.builder()
                            ...
                            .message("Employee " + employee.getFirstName() + " " +
                                    employee.getLastName() + " added to department " + department.getName())
                            .senderId(null)
                            .receiverId(null)
            ...
            log.error("Notification failed for employee creation", e);
        }
    ...
    public EmployeeResponseDto updateEmployee(EmployeeRequestDto request, UUID id) {
        ...
        try {
            ...
            log.error("Notification failed for employee update", e);
        }
    ...
    public EmployeeResponseDto uploadAvatar(String employeeId, MultipartFile file) {
        ...
        try {
            String bucketName = "hrms--profile-images";
            String folder = "avatars/";

            String originalName = Objects.requireNonNull(file.getOriginalFilename());
            String extension = originalName.substring(originalName.lastIndexOf("."));

            String fileName = folder + employeeId + "_" + System.currentTimeMillis() + extension;
            ...
            String cloudFrontUrl =
                    "https://d3qs09ype2r7pk.cloudfront.net/" + fileName;
